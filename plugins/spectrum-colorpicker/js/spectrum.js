...
(function (factory) {
  ...
  var defaultOpts = {
    ...
    replaceInput = [
      "<div class='sp-replacer' style='padding:4px;'>",
    ...
    markup = (function () {
      ...
      return [
        ...
        "<div class='sp-palette-button-container sp-cf text-center' style='font-size: 12px;'>",
        "<button type='button' class='sp-palette-toggle p-1'style='width: 100%;'></button>",
        '</div>',
        '</div>',
        ...
        "<div class='sp-button-container sp-cf text-center'>",
        "<button type='button' class='sp-choose p-1 ' style='width: 100%;'></button>",
        "<a class='sp-cancel p-1 mt-1' href='#' ></a>",
