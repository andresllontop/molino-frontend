...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector(".cerrar-almacen").innerHTML = " ";
    ...
    beanRequestAlmacen.operation = 'paginate';
    beanRequestAlmacen.type_request = 'GET';

    processAjaxAlmacen();
    removeClass(document.querySelector("#listaAlmacenHtml"), "d-none");
    removeClass(document.querySelector("#btnSeleccionarEstablecimiento").parentElement, "d-none");
...
function addAlmacen(almacen = undefined) {
    ...
    establecimientoSelected = (almacen == undefined) ? undefined : almacen.establecimiento;
    document.querySelector('#txtEstablecimientoProducto').value = (almacen == undefined) ? '' : almacen.establecimiento.nombre;
...
function toListAlmacen(beanPagination) {
    ...
    beanPagination.list.forEach((almacen) => {
        row = `
			...
			<div class="dt-widget__item m-0 py-1 pr-3" >
              ...
              <div class="dt-widget__info ">
                <p class="dt-widget__subtitle " >
                ${almacen.establecimiento.nombre}
                </p>
              </div>
              <!-- /widget info -->
              <!-- Widget Extra -->
    ...
    addEventsAlmacens();
    if (beanRequestAlmacen.operation == 'paginate') {
        document.querySelector('#txtFilterAlmacen').focus();
    }
