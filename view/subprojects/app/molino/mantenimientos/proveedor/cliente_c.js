      ...
      row = `
						<!-- Tasks -->
                            <div class="dt-checkbox dt-checkbox-todo pb-2 pt-2 row-selected-celeste-claro" >
                                ...
                                <label class="dt-checkbox-content" for="${cliente.idcliente}">${cliente.documento + " - " + getStringCapitalize(cliente.nombre) + " " + getStringCapitalize(cliente.apellido)}</label>
                            </div>
                            <!-- /tasks -->
			`;
    ...
    .forEach(function (element) {
      element.onclick = function () {
        ...
        if (clienteCSelected != undefined) {
          ...
          ).value = getStringCapitalize(clienteCSelected.nombre) + " " + getStringCapitalize(clienteCSelected.apellido);
