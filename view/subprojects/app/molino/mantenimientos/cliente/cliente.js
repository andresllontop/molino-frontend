...
function processAjaxCliente(valor = undefined) {
    ...
    if (
        ...
        try {
            json = {
                tipo_cliente: parseInt(1),
                tipo_documento: parseInt(document.querySelector('#txtTipoDocumentoCliente').value),
                documento: document.querySelector('#txtDocumentoCliente').value.trim(),
...
function validateFormCliente() {
    let numero = numero_campo(
        ...
        document.querySelector('#txtDocumentoCliente'),
    ...
    if (document.querySelector('#txtTipoDocumentoCliente').value == 0) {
        document.querySelector('#txtTipoDocumentoCliente').focus();
