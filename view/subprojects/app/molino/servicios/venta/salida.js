...
var toListSalida = (beanPagination) => {
    ...
    beanPagination.list.forEach((salida) => {
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <ul class="invoice-list">
                        ...
                        <span class="invoice-list__number">${salida.total} SC</span> 
                        <span class="invoice-list__number d-none">${salida.total_otro} x KG</span>
                          <span class="invoice-list__label">Cantidad</span>
                          <span class="custom-tooltip bg-success">${"S/." + numeroConComas(salida.monto)}</span>
                        </li>
                      </ul>
                    </div>
                    <!-- /media body -->
        ...
        row = `
                  ...
                  <div class="dt-widget__item">
                    ...
                    <!-- Widget Info -->
                    <div class="dt-widget__info ">
                      <p class="dt-widget__subtitle ">${salida.cliente.nombre}
                      </p>
                    </div>
                    <!-- /widget info -->
                    <!-- Widget Info -->
                    ...
                    <!-- Widget Info -->
                    <div class="dt-widget__info ">
                      <p class="dt-widget__subtitle ">${salida.total} SC
                      </p>
                      <p class="dt-widget__subtitle d-none">${salida.total_otro} KG
                      </p>
                    </div>
                    <!-- /widget info -->
                    <!-- /widget info -->
                    <div class="dt-widget__info ">
                        <p class="dt-widget__subtitle ">S/. ${numeroConComas(salida.monto)}</p>
                    </div>
                    <!-- /widget info -->
                    <!-- Widget Info -->
                    <div class="dt-widget__info ">
    ...
    if (beanRequestSalida.operation == 'ventas/paginate')
...
var addEventsSalidas = () => {
    document.querySelectorAll('.ver-salida').forEach((btn) => {
        ...
        btn.onclick = function () {
            ...
            addClass(document.querySelector('#FrmPresentacionC'), "d-none");
            addClass(document.querySelector('#FrmPresentacionC').nextElementSibling, "d-none");
            addClass(document.querySelector('#FrmPresentacionC').previousElementSibling, "d-none");
        };
    });
...
function tipoSalida(key) {
    switch (parseInt(key)) {
        case 2:
            return '<span class="badge badge-pill badge-info mb-1 mr-1">Entrada</span>';
        case 4:
