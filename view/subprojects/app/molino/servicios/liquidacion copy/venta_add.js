  ...
  beanPagination.forEach((detalle_venta) => {
    ...
    row = `
      ...
      detalle_venta.iddetalle_venta
			...
			<!-- Widget Extra -->
				<div class="dt-widget__extra align-content-center">
					<!-- Hide Content -->
        ...
        <!-- Widget Info -->
          ...
          <p class="dt-widget__subtitle text-right">S/. ${numeroConComas((detalle_venta.cantidad * detalle_venta.precio * (1 - (detalle_venta.porcentaje_igv / 100))).toFixed(2))}</p>
				</div>
        <!-- /widget info -->
        <!-- Widget Info -->
				<div class="dt-widget__info" style="min-width: 100px;">
          <p class="dt-widget__subtitle border-left text-right">S/. ${numeroConComas((detalle_venta.cantidad * detalle_venta.precio).toFixed(2))}</p>
				</div>
        <!-- /widget info -->
			</div>
			<!-- /widgets item -->
